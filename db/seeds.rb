...
#{Faker::Hipster.paragraph(6)}
  ...
  # Speakers
  submitted_proposal_1.speakers.create!(speaker_name: speaker_1.name, speaker_email: speaker_1.email, bio: "I am a speaker for cool events!", webpage: speaker_1.webpage, user: speaker_1, event: seed_event, photo_url: "http://foo.img", experience: "None")
  submitted_proposal_1.speakers.create!(speaker_name: speaker_2.name, speaker_email: speaker_2.email, bio: "I know a little bit about everything.", webpage: speaker_2.webpage, user: speaker_2, event: seed_event, photo_url: "http://foo.img", experience: "None")
  submitted_proposal_2.speakers.create!(speaker_name: speaker_2.name, speaker_email: speaker_2.email, bio: "I know a little bit about everything.", webpage: speaker_2.webpage, user: speaker_2, event: seed_event, photo_url: "http://foo.img", experience: "None")
  soft_accepted_proposal.speakers.create!(speaker_name: speaker_3.name, speaker_email: speaker_3.email, bio: "I am the best speaker in the entire world!", webpage: speaker_3.webpage, user: speaker_3, event: seed_event, photo_url: "http://foo.img", experience: "None")
  soft_waitlisted_proposal.speakers.create!(speaker_name: speaker_4.name, speaker_email: speaker_4.email, bio: "I specialize in teaching cutting edge programming techniques to beginners.", webpage: speaker_4.webpage, user: speaker_4, event: seed_event, photo_url: "http://foo.img", experience: "None")
  soft_rejected_proposal.speakers.create!(speaker_name: speaker_5.name, speaker_email: speaker_5.email, bio: "I like cookies and rainbows.", webpage: speaker_5.webpage, user: speaker_5, event: seed_event, photo_url: "http://foo.img", experience: "None")
  withdrawn_proposal.speakers.create!(speaker_name: speaker_3.name, speaker_email: speaker_3.email, bio: "I am the best speaker in the entire world!", webpage: speaker_3.webpage, user: speaker_3, event: seed_event, photo_url: "http://foo.img", experience: "None")
